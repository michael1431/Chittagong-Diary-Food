                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4>
                                    <i class="fas fa-globe"></i>{{ $invoice->cost_id ? 'EXPENSE VOUCHER':(($invoice->total_amount > 0) ?"INVOICE" : "MONEY RECEIPT")}}
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col text-right">
                                <br>
                                <b>{{$invoice->cost_id? 'Voucher No':'Invoice No'}} :</b> {{ $invoice->invoice_no }}<br>
