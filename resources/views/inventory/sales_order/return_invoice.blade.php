...
@section('title','Sales Return Details  - CDF ')
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Sales Return Details</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="card-body" style="display: block;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <hr>
                                          {{ Form::open(['route'=>'invoice.returnStore','method'=>'post', 'class'=>'form-horizontal']) }}
                                        ...
                                        <table class="table-hover table-bordered  table goodsinProList">
                                            <thead>
                                                ...
                                                <tr>   
                                                    ...
                                                    <th class="text-center"><label class="checkbox-inline"><input type="checkbox" value="emp" id="employee" onclick="show_amount(1)"> Employee</label>\
                                                    --}} 
                                                    </th>
                                            ...
                                            <tbody class="proList">
                                                ...
                                                <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="form-group"> <input class="form-control-sm" type="number" value="0" name="qty[{{$sale->id}}]" min="0" max="{{($sale->qty - 0) }}"></div>
                                                        </td>
