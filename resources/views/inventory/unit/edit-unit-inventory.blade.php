...
@section('title','Unit - Inventory WELL GROUP ')
@section('content')
                    ...
                    <div class=" bg-light">
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::model($unit,['route'=>['inventory.unit.update',$unit->id],'method'=>'POST', 'class'=>'form-horizontal']) }}
                                @include('inventory.unit.form-unit-inventory',['buttonText'=>'Update Unit'])
                                {{ Form::close() }}
                            </div>
                        </div>
                    </div>
