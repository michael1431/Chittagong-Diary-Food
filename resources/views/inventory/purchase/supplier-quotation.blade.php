                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 table-responsive">
                            <div class="row">
                                @php $i=1; $count = 0; $data=[]; @endphp

                                @foreach($quotations as $key=>$quotation)
                                    @php  $sup = \App\Supplier::findOrFail($quotation->supplier_id); @endphp

                                    <div class="col-lg-6">
                                        <h4 class="bg-info" style="padding: 5px 10px;"> {{ $sup->name }} </h4>
