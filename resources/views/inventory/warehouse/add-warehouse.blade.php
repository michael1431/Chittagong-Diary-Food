...
@section('title','Warehouse - Inventory WELL GROUP ')
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Manage  Warehouse  </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class=" bg-light">
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-body" style="display: block;">
                                ...
                                @include('inventory.warehouse.form-warehouse',['buttonText'=>'Save Warehouse'])
                                {{ Form::close() }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-warning card-outline">
                        <div class="card-header">
                            <div class="card-title">
                                <h5 class="text-info">Inventory Warehouse list </h5>
                            </div>
